...
Mapper.prototype.buildGraph = function(universe) {
    var g = new Graph;
...
Mapper.prototype.shortestPath = function(start, finish, G) {
...
Mapper.prototype.testPaths = function(universe) {
    var g = this.buildGraph(universe);
